...
def draw(canvas):
    ...
    if (paddle1_pos + paddle1_vel <= HEIGHT - HALF_PAD_HEIGHT
        and paddle1_pos + paddle1_vel >= HALF_PAD_HEIGHT):
    ...
    # draw scores
    canvas.draw_text(str(score1), [WIDTH * .35, HEIGHT * .25], 50, "White")
    canvas.draw_text(str(score2), [WIDTH * .6, HEIGHT * .25], 50, "White")
